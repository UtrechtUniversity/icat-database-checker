# This file has a list of iRODS ICAT schemas. They have been copied from the iRODS source code
# at ./plugins/database/src/icatSysTables.sql.pp.in
# See https://github.com/irods/irods for copyright information.

# No flake tests because of line lengths
# flake8: noqa
...
def get_schema(catalog_schema_version):
    if catalog_schema_version == 8:
        return """
